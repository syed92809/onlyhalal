    ...
    if (email == "" ) {
      ...
      .then(async data => {
        ...
        if (!data.success) {
          ...
          // Save the verification code in async storage
          
          await AsyncStorage.setItem('verificationCode', data.verificationCode.toString());
          await AsyncStorage.setItem('resetEmail', email);

          console.log("Email sent")
          show_success_message('Email sent')

          navigation.push('ResetVerificationScreen');
